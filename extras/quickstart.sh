...
Error: /dev/ppp is missing. LXC containers require configuration.
       See: https://github.com/wizd/setup-ipsec-vpn/issues/1014
EOF
  exit 1
  fi
}
...
get_setup_url() {
  base_url1="https://github.com/wizd/setup-ipsec-vpn/raw/master"
  base_url2="https://github.com/wizd/setup-ipsec-vpn/raw/master"
